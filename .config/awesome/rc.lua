...
globalkeys = mytable.join(
    ...
    awful.key({ modkey, "Shift"   }, "o", function ()
        ...
        s.swap(s, s.get_next_in_direction(s, "right"))
    end,
              {description = "swap motinors", group = "tag"}),
    ...
    -- Suppressed by https://github.com/intrntbrn/awesomewm-vim-tmux-navigator
    -- awful.key({ modkey }, "j",
    --     function()
    ...
    awful.key({ modkey, "Shift" }, "n", function ()
              awful.spawn.with_shell("feh --randomize --bg-fill /usr/share/backgrounds/*") end,
    ...
    awful.key({ altkey, "Control" }, "m",
        function ()
            os.execute("amixer -q set Master 100")
        end,
        {description = "volume 100%", group = "hotkeys"}),
    awful.key({ altkey, "Control" }, "0",
        function ()
            os.execute("amixer -q set Master 0")
        end,
