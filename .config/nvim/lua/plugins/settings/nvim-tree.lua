...
local function vimclosenvimtree()
  ...
  -- local winnr    = vim.api.nvim_exec("winnr('$')", true)
  -- local bufname  = vim.api.nvim_exec('bufname()', true)
  -- local bufname2 = 'Nvim.Tree_' .. vim.api.nvim_exec('tabbagenr()', true)

  -- if winnr == 1 and bufname == bufname2 then
  --   vim.cmd('quit')
  -- end
end
